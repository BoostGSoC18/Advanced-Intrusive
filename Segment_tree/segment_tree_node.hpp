...
class segment_tree_node_traits
{
    ...
    BOOST_INTRUSIVE_FORCEINLINE static void set_position(int position , node_ptr &n)
    {
        n->position=position;
    }
    ...
    BOOST_INTRUSIVE_FORCEINLINE static void get_position(node_ptr &n)
    {
        return n->position;
    }
    BOOST_INTRUSIVE_FORCEINLINE static void get_start(node_ptr &n)
    {
        return n->start;
    }
    BOOST_INTRUSIVE_FORCEINLINE static void get_end(node_ptr &n)
    {
        return n->end;
    }
};
