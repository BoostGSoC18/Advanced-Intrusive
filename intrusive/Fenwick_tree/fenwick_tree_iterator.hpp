...
class fenwick_tree_iterator
{
   ...
   BOOST_INTRUSIVE_FORCEINLINE fenwick_tree_iterator()
   {}

   BOOST_INTRUSIVE_FORCEINLINE explicit fenwick_tree_iterator(const node_ptr & nodeptr, const const_value_traits_ptr &traits_ptr)
   ...
   {   return this->operator_arrow(detail::bool_<stateful_value_traits>()); }
    ...
    BOOST_INTRUSIVE_FORCEINLINE fenwick_tree_iterator get_child(int n)
   {
      members_.nodeptr_=members_.nodeptr_->children[n-1];
   }
